document.addEventListener("DOMContentLoaded", function () {
    ...
    const salesTrends = JSON.parse(document.getElementById("sales-trends").textContent);
    const bestProducts = JSON.parse(document.getElementById("best-products").textContent);
    const topCustomers = JSON.parse(document.getElementById("top-customers").textContent);
    const employeeOrders = JSON.parse(document.getElementById("employee-orders").textContent);
    const shipperOrders = JSON.parse(document.getElementById("shipper-orders").textContent);
    ...
    createChart(
        ...
        ["red", "green", "blue", "yellow", "orange", "purple", "teal", "pink", "gray"," indigo"]
    );
